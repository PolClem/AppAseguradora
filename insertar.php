...
$sqlCli = "INSERT INTO clientes (nombre, apellido, dni, domicilio, telefono, provincia, ciudad) VALUES  ('$nombre', '$apellido', '$dni', '$domicilio', '$telefono', '$provincia', '$ciudad')";
$query = mysqli_query($conexion, $sqlCli);
if($query){
